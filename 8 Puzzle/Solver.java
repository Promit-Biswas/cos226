 ...
 * Description: Solves the 8-puzzle problem for arbitrary
 * NxN grids using the A* algorithm.
 * Compilation: javac Solver.java
 * Execution: java Solver <input filename>
 * Dependencies: MinPQ, Stack, In, StdOut
 */
